...
namespace AssetLens.Reference.TreeWindow
{
	...
	//
	// 	public static List<RefTreeElement> GenerateRandomTree(int numTotalElements)
	// 	{
	// 		int numRootChildren = numTotalElements / 4;
	// 		IDCounter = 0;
	// 		var treeElements = new List<RefTreeElement>(numTotalElements);
	//
	// 		var root = new RefTreeElement("Root", -1, IDCounter);
	...
	// 		return treeElements;
	// 	}
	// 	static void AddChildrenRecursive(TreeElement element, int numChildren, bool force, int numTotalElements, ref int allowedDepth, List<RefTreeElement> treeElements)
	// 	{
	...
	// 				return;
	//
	// 			var child = new RefTreeElement("Element " + IDCounter, element.depth + 1, ++IDCounter);
